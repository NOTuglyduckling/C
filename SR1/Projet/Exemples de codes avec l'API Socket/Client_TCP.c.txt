/* Un client TCP qui se connecte au serveur tournant sur
   localhost "127.0.0.1" port 30000
   il lui envoie la chaine "Hello!"
*/
...
write(to_server_socket,"Hello!",6);
